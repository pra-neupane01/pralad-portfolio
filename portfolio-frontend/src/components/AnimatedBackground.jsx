...
export default function AnimatedBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <motion.div
        className="absolute -left-28 top-20 h-72 w-72 rounded-full bg-cyan/20 blur-3xl"
        animate={{ x: [0, 38, 0], y: [0, 20, 0], opacity: [0.32, 0.55, 0.32] }}
        transition={{ duration: 9, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute right-0 top-24 h-80 w-80 rounded-full bg-violet/20 blur-3xl"
